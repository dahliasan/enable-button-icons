...
function enable_button_icons_render_block_button($block_content, $block)
{
    ...
    $icons = array(
        ...
        'arrow-left-circle' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M16 12H8M12 8l-4 4 4 4"/></svg>',
        'arrow-right-circle' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"  stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M8 12h8M12 16l4-4-4-4"/></svg>',
